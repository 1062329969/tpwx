...
function addImage(src) {
    var newElement = "<li><img class='content' src='" + src + "' style=\"height:100px;\"><img class='button' src=" + "/Public/Home/image/fancy_close.png><input type='hidden' name='mt_img[]' value='"+ src +"' /></li>";
...
var del = function () {
    ...
    $.ajax({
        ...
        url: "/Public/Home/js/ajax.php?act=del", //调用WebService的地址和方法名称组合---WsURL/方法名
        data: "src=" + src,
